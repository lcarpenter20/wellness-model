...
Does location effect happiness of a race? 

##Hypothesis: 

Location and Race does not have an effect on someone's happiness 
$\beta{_0} = 0$
$\beta{_A} \neq 0$ 
...
```{r}
race_location <- lm(wellbeing_response ~ race + residence, data = df)
